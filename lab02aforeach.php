...
if(isset($_POST['submit']))
		{//if there is something submitted . .
			...
			echo 'You chose ';
				...
				foreach(choice as $toppings){
					echo $toppings. ', ';
					/*else prev(end($toppings))
					{
						echo $choice[$i]. ' and';			
					}
					else end($toppings)
	...
	/*else if ((isset($_POST['submit'])) && $a = 0);
		{
			...
			<h4>
				<form action=" '. THIS_PAGE .' " method="post">
					...
					<h3>Choose your toppings:</h3> <br> 
						...
						<ul id="list-toppings" >
						<li><label>
							<input type="checkbox" name="choice[]" value="chocolate" unchecked />
								<div class="checkbox-text">
									Chocolate Sauce
								</div><!--.checkbox-text-->
						</label></li>
						<li><label>
							<input type="checkbox" name="choice[]" value="peanuts" unchecked />
								<div class="checkbox-text">
									Peanuts
								</div><!--.checkbox-text-->
						</label</li>
						<li><label>
							<input type="checkbox" name="choice[]" value="oreochunks" unchecked />
								<div class="checkbox-text">
									Oreo Chunks
								</div><!--.checkbox-text-->
						</label></li>
						<li><label>
							<input type="checkbox" name="choice[]" value="caramel" unchecked />
								<div class="checkbox-text">
									Caramel Sauce
								</div><!--.checkbox-text-->
						</label></li>
						<li><label>
							<input type="checkbox" name="choice[]" value="m&ms" unchecked />
								<div class="checkbox-text">
									M&Ms
								</div><!--.checkbox-text-->
						</label></li>
						<li><label>
							<input type="checkbox" name="choice[]" value="heath" unchecked />
								<div class="checkbox-text">
									Heathbar Chunks
								</div><!--.checkbox-text-->
						</label></li>
